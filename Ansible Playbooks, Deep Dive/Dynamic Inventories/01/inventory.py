...
class Inventory(object):# here defining the Inventory class in here 
    ...
    def __init__(self, include_hostvars_in_list):
        ...
        self.define_inventory() # this willl set up the self.groups and self.hostvrs 
    ...
    def define_inventory(self):# this will set the hostvars and the groupvars for the inventory 
        self.groups = {
            "centos": {
    ...
    # Pretty print JSON
    def print_json(self, content): # printing the value as the JSON
    ...
    def configure_logger(self):
        ...
        self.hdlr = logging.FileHandler('ansible_dynamic_inventory.log')
